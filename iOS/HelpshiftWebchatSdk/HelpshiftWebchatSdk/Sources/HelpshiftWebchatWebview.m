...
+ (instancetype) sharedInstance {
    ...
    dispatch_once(&onceToken, ^{
        ...
        NSString *jsPath = [[NSBundle bundleForClass:[self class]] pathForResource:@"HelpshiftWebchatWrapper" ofType:@"js"];
        NSString *jsSource = [NSString stringWithContentsOfFile:jsPath encoding:NSUTF8StringEncoding error:nil];
        NSURL *localHTML = [[NSBundle bundleForClass:[self class]] URLForResource:@"helpshift-webchat" withExtension:@"html"];
        ...
        NSString *platformId = [PersistentData stringForKey:@"platformId"];
        NSString *domain = [PersistentData stringForKey:@"domain"];
        WKUserScript *script = [[WKUserScript alloc]
                                initWithSource:[NSString stringWithFormat:jScript, platformId, domain] injectionTime:WKUserScriptInjectionTimeAtDocumentEnd
        ...
        [instance loadHTMLString:contentsOfHTML baseURL:[NSURL URLWithString:@"https://localhost"]];
